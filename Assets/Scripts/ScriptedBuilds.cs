...
public class ScriptedBuilds
{
    ...
    {
        PerformServerBuild(BuildTarget.StandaloneLinux64, BuildOptions.EnableHeadlessMode | BuildOptions.StrictMode,
    ...
    {
        PerformServerBuild(BuildTarget.StandaloneOSX, BuildOptions.EnableHeadlessMode | BuildOptions.StrictMode,
            StandaloneBuildSubtarget.Server);
    }
